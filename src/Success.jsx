...
const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .icon-wrap { margin-bottom: 28px; animation: popIn 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s both; }
  .icon-ring {
  ...
  .saving-msg { font-size: 12px; color: var(--muted); letter-spacing: 1px; margin-bottom: 16px; }
`;
...
export default function Success() {
  ...
  useEffect(() => {
    ...
    if (data.service && data.date && data.time) {
      setBooking(data);
      // Save to Supabase and send emails now that deposit is paid
      Promise.allSettled([
        saveBooking(data),
        sendEmail({
      ...
      setSaved(true); // no params, just show success page
    }
  }, []);
        ...
        <div className="content">
          ...
          {booking && (
            <div className="detail-card">
              ...
              <div className="detail-row"><span className="detail-key">Name</span><span className="detail-val">{booking.client_name}</span></div>
          ...
          <div className="next-steps">
            ...
            <div className="next-step-item"><span className="step-dot">✦</span><span>Save inspo pics! DM us on Instagram @acrylicfaerie if you have questions.</span></div>
