const styles = `
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .icon-ring {
    ...
    justify-content: center;
    margin: 0 auto;
    background: radial-gradient(circle, #2a0e1a 0%, var(--bg2) 100%);
    box-shadow: 0 0 40px #c4415a44, inset 0 0 20px #c4415a11;
    font-size: 36px;
  }
  ...
  .icon-ring { animation: popIn 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) 0.2s both, glow 3s ease-in-out 1s infinite; }
        ...
        <div className="content">
          ...
          <div className="detail-card">
            <div className="detail-row">
              <span className="detail-key">Studio</span>
              <span className="detail-val">Acrylic Faerie</span>
            </div>
            <div className="detail-row">
              <span className="detail-key">Location</span>
              <span className="detail-val">San Antonio, TX</span>
            </div>
            <div className="detail-row">
              <span className="detail-key">Deposit Paid</span>
              <span className="detail-val">$10.00 ✦</span>
            </div>
          </div>
          ...
          <div className="next-steps">
            ...
            <div className="next-step-item">
              ...
              <span>Check your email for your booking confirmation with all the details.</span>
            </div>
            <div className="next-step-item">
              <span className="step-dot">✦</span>
              <span>Come with clean, bare nails — no polish or product on them.</span>
            </div>
            <div className="next-step-item">
              <span className="step-dot">✦</span>
              <span>Save inspo pics! DM us on Instagram @acrylicfaerie if you have questions.</span>
            </div>
            <div className="next-step-item">
              <span className="step-dot">✦</span>
              <span>Need to reschedule? Email us at acrylicfaerie.biz@gmail.com as soon as possible.</span>
            </div>
          </div>
